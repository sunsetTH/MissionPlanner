...
namespace MissionPlanner.GCSViews
{
    ...
    BackstageViewPage Parent = null, bool advanced = false)
        ...
        private void HardwareConfig_Load(object sender, EventArgs e)
        {
            ...
            AddBackstageViewPage(typeof(Calibration),("校准"));
            //AddBackstageViewPage(typeof(ConfigTradHeli), rm.GetString("backstageViewPagetradheli.Text"), isHeli);
            AddBackstageViewPage(typeof(ConfigFrameType), rm.GetString("backstageViewPageframetype.Text"), isCopter && !isCopter35plus);
            AddBackstageViewPage(typeof(ConfigFrameClassType), rm.GetString("backstageViewPageframetype.Text"), isCopter && isCopter35plus);
            ...
            AddBackstageViewPage(typeof(ConfigGPSInject), "RTK/GPS Inject", true);
            //AddBackstageViewPage(typeof(Sikradio), rm.GetString("backstageViewPageSikradio.Text"), true);
            //AddBackstageViewPage(typeof(ConfigBatteryMonitoring), rm.GetString("backstageViewPagebatmon.Text"));
            AddBackstageViewPage(typeof(ConfigBatteryMonitoring2), rm.GetString("backstageViewPageBatt2.Text"));
            ...
            AddBackstageViewPage(typeof(ConfigMount), rm.GetString("backstageViewPagegimbal.Text"));
